...
## Quick Start
For the application to run smoothly without having to wait for the app to build a feedback table. Download the .pkl feedback table at the google drive link:
